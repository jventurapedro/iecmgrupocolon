...
while indice < len(edades):
    print(edades[indice])
    indice = indice + 1         # Se puede usar indice += 1
...
# Quitar todas las coincidencias de un Array. Con REMOVE se elimina la primera
#       coincidencia que encuentre. Para ir eliminando mas de un valor
