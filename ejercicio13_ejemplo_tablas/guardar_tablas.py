...
# Buscar cuantos coches BMW de color azul hay
...
print("Hay " + str(cantidad) + " coches BMW de color azul")

salida3 = "Hay " + str(cantidad) + " coches BMW de color azul"

with open("C:/ejemplos/" + "BMW_azul.txt", mode="w") as fichero:   

    fichero.write(salida3)
